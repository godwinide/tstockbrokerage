    ...
    function i(r) {
        ...
        new class extends class {
            ...
            _replaceScript(i) {
                ...
                this.iframe = this._createIframe(T, c, a, E, I), this._addCSPErrorListener(c), u && this.iframe.setAttribute("nonce", u);
            ...
            get propertiesToWorkWith() {
                return ["colorTheme", "currencies", "customer", "disableCrossClickHref", "height", "largeChartUrl", "locale", "width", "backgroundColor"]
            }
        }
    })()
})();