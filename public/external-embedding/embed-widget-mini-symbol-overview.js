(() => {
    ...
    function i(r) {
        ...
        const h = ["locale", "symbol", "market"],
            ...
            g = "BATTLE";
        const u = ["customer", "symbol", "dateRange", "trendLineColor", "fallingTrendLineColor", "growingTrendLineColor", "lineWidth", "underLineColor", "underLineBottomColor", "width", "height", "locale", "colorTheme", "isTransparent", "noTimeScale", "chartOnly", "autosize", "largeChartUrl", "scalePosition", "useLastSession"];
        new class extends class {
            ...
            _replaceScript(i) {
                ...
                this.iframeContainer = h && f ? h : document.createElement("div"), o && (this.settings = this.filterRawSettings(o)), o && this._validateSettings() || (console.error("Invalid settings provided, fall back to defaults"),
                ...
                if (I ? ((0, t.ensureNotNull)(I.parentElement).replaceChild(this.iframe, I), null == n || n.remove()) : f ? (this.iframeContainer.appendChild(this.iframe), null == n || n.remove()) : (this.iframeContainer.appendChild(this.iframe), h.replaceChild(this.iframeContainer, (0, t.ensureNotNull)(n))), this.shouldListenToIframeResize && function(t, e, i) {
                    ...
                    t.style.height = w, t.style.lineHeight = w, void 0 !== v && (t.style.width = v), t.style.textAlign = "center",
                        t.style.verticalAlign = "middle", t.innerHTML = m.innerHTML, this.iframeContainer.appendChild(t)
                }
            }
            _iframeSrcBase(t) {
            ...
            _createIframe(t, e, i, r, n) {
                ...
                i && (s.id = i), this.settings.enableScrolling || s.setAttribute("scrolling", "no"), s.setAttribute("allowtransparency", "true"), s.setAttribute("frameborder", "0"), s.style.userSelect = "none", s.style.boxSizing = "border-box", s.style.display = "block", s.style.height = t, s.style.width = "100%";
